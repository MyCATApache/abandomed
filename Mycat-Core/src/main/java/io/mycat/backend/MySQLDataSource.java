...
public class MySQLDataSource {
    ...
    public MySQLBackendConnection createNewConnectionOnReactor(String reactor, String schema, MySQLFrontConnection mySQLFrontConnection, BackConnectionCallback userCallback) throws IOException {
        MySQLBackendConnection con = factory.make(this, reactor, schema, mySQLFrontConnection, userCallback);
    ...
    private MySQLBackendConnection takeCon(MySQLBackendConnection conn, final MySQLFrontConnection mySQLFrontConnection, String schema) {
        conn.setMySQLFrontConnection(mySQLFrontConnection);
    ...
    public MySQLBackendConnection getConnection(String reactor, String schema, boolean autocommit, final MySQLFrontConnection mySQLFrontConnection, final BackConnectionCallback userCallback)
            throws IOException {
        ...
        if (con != null) {
            ...
            if (activeCons + 1 > size) {// 下一个连接大于最大连接数
                ...
                MySQLBackendConnection mySQLBackendConnection = createNewConnectionOnReactor(reactor, schema, mySQLFrontConnection, userCallback);
