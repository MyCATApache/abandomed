...
public class PhysicalDBNode {
    ...
    public BackendConnection getConnection(String reactor,String schema, boolean autoCommit, // RouteResultsetNode
            // rrs,
        ...
        if (dbPool.isInitSuccess()) {
            ...
            // this.database);
            // } else {
            con = dbPool.getSource().getConnection(reactor,schema, autoCommit, // handler,
                    attachment);
            // }
        } else {
